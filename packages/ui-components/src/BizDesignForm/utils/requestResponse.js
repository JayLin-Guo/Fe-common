...
import { jsonParseStringify } from '@/components/BizDesignForm/utils/design'
 ...
 */
export const getRequestEvent = (props, key) => {
  let event
  const propsEvent = (props)[key]
